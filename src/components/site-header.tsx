            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="iconSm" className="relative">
                  ...
                  <Badge className="absolute -top-1 -right-1 bg-red-500 text-white text-xs min-w-0 h-5 px-1.5">
                    3
                  </Badge>
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent align="end" className="w-80">
                ...
                <div className="p-2 space-y-2 max-h-96 overflow-y-auto">
                  <div className="p-3 bg-blue-50 rounded-lg border-l-4 border-blue-500">
                    <p className="text-sm font-medium text-gray-900">새로운 프로젝트 참여 요청</p>
                    <p className="text-xs text-gray-600 mt-1">김개발자님이 React 프로젝트에 참여를 요청했습니다.</p>
                    <p className="text-xs text-gray-500 mt-2">5분 전</p>
                  </div>
                  <div className="p-3 bg-green-50 rounded-lg border-l-4 border-green-500">
                    <p className="text-sm font-medium text-gray-900">스터디 승인 완료</p>
                    <p className="text-xs text-gray-600 mt-1">TypeScript 스터디 참여가 승인되었습니다.</p>
                    <p className="text-xs text-gray-500 mt-2">1시간 전</p>
                  </div>
                  <div className="p-3 bg-purple-50 rounded-lg border-l-4 border-purple-500">
                    <p className="text-sm font-medium text-gray-900">새로운 멘토링 매칭</p>
                    <p className="text-xs text-gray-600 mt-1">박멘토님과 멘토링이 매칭되었습니다.</p>
                    <p className="text-xs text-gray-500 mt-2">2시간 전</p>
                  </div>
                </div>
              </DropdownMenuContent>
            </DropdownMenu>
